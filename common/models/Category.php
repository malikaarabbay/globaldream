...
class Category extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Param::className(), ['id' => 'param_id'])->viaTable('{{%category_param}}', ['category_id' => 'id'])->orderBy('sort_index');
    }

    public function getFilterParams()
    {
        return $this->hasMany(Param::className(), ['id' => 'param_id'])->where(['{{%param}}.is_filter' => 1])->viaTable('{{%category_param}}', ['category_id' => 'id'])->orderBy('sort_index');
    }
